                    ...
                    <div class="tab-content">
                        ...
                        <div class="d-flex justify-content-center" style="font-size:18px; margin-bottom: 18px; margin-top: -25px;font-weight: bold;">
                            <div class="col-md-4 pe-5">                        
                              <lable style="color:#1C806A;">根據下方行程表地點搜尋鄰近相關景點...</lable>
                            </div>
                            <!-- 這個 span 用來顯示 value -->
                            ...
                            <div class="col-md-4 form-check form-switch">
                                ...
                                <div class="col-sm-1">
                                <input class="form-check-input" type="checkbox" role="switch" id="f_SwitchCheck" style="margin-left:-15px">
                                </div>
                                ...
                                <!-- <h5>根據所有</h5>                        
                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="margin-left:200px">
                                <h5>根據收藏</h5> -->
                            </div>
                          </div>
...
<div class="modal fade" id="timeConflictModal" tabindex="-1" role="dialog" aria-labelledby="timeConflictModalLabel" aria-hidden="true">
  ...
  <script>
      ...
      <?php endif; ?>
          ...
          function fa_sendRequest(att_id_param) {
                  let kmValue = document.getElementById("km-input").value;
                  document.getElementById("km-display").textContent = kmValue;
                  
                  let att_id = att_id_param || existingTiles[0].att_id;  // 使用提供的att_id或預設值
                  let xhr = new XMLHttpRequest();
                  xhr.open('POST', 'php/f_attractionsnearbysearch.php', true);
                  xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
              ...
              xhr.send('att_id=' + att_id + '&radius=' + kmValue);
                ...
                // 獲取checkbox元素
                var checkbox = document.getElementById('f_SwitchCheck');
                ...
                function updateAndRenderTiles() {
                  ...
                  existingTiles.forEach(function(tileData) {
                    ...
                    searchBtn.on("click", function(event) {
                        ...
                        fa_sendRequest(att_id); // 使用 att_id 進行搜索
                        ...
                        // 新增的功能: 將 time 的值同步到 time-input，並去掉後面的 :SS
                        var truncatedTime = time.substring(0, 5);
                        $("#time-input").val(truncatedTime);
