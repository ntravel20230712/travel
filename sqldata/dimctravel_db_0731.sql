...
CREATE TABLE IF NOT EXISTS `attractions` (
  ...
  `att_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `att_City` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `att_CityNum` int NOT NULL,
  `att_Address` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `att_lat` decimal(18,14) NOT NULL,
  `att_lng` decimal(18,14) NOT NULL,
  `att_type` char(10) COLLATE utf8mb4_general_ci NOT NULL,
  `att_StartTime` time NOT NULL,
  `att_EndTime` time NOT NULL,
  `att__Week` char(10) COLLATE utf8mb4_general_ci NOT NULL,
  `att_content` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `att_picture` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `att_Fraction` int DEFAULT NULL,
  `ATT_AREANAME` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ATT_AREAID` char(8) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(26, '何家三星蔥餡餅', '宜蘭縣', 19, '266宜蘭縣三星鄉三星路八段2號', '24.66154860000000', '121.62151330000000', '食', '11:00:00', '17:00:00', '每天', '好好吃', NULL, 3, '三星', '266', 81),
(25, '張美阿嬤農場', '宜蘭縣', 19, '266宜蘭縣三星鄉行健溪一路二段161號', '24.67486710000000', '121.67560800000000', '遊', '09:00:00', '17:30:00', '1234567', '很好玩', NULL, 3, '三星', '266', 16),
(24, '廟口紅茶', '花蓮縣', 18, '970花蓮縣花蓮市成功街216號', '23.97335870000000', '121.60613370000000', '食', '06:00:00', '22:00:00', '1234567', '好喝紅茶冰', NULL, 3, '花蓮市', '970', 15),
...
(22, '梧饕池上飯包', '台東縣', 17, ' 958台東縣池上鄉忠孝路259號', '23.12425630000000', '121.22090410000000', '食', '10:30:00', '19:00:00', '1234567', NULL, NULL, 3, '池上', '958', 9),
...
(15, '邱家生魚片', '屏東縣', 16, '946屏東縣恆春鎮大光路79-51號', '21.94588920000000', '120.74251450000000', '食', '11:00:00', '23:30:00', '1234567', NULL, NULL, 4, '恆春鎮', '946', 1),
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `mem_pwd` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `mem_email` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`mem_id`),
...
CREATE TABLE IF NOT EXISTS `memdata` (
  `mem_email` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `mem_name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `mem_phone` char(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `reviews` (
  ...
  `mem_id` int NOT NULL,
  `mem_name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `rev_title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rev_content` mediumtext COLLATE utf8mb4_general_ci,
  `rev_picture` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rev_star` char(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rev_city` char(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`rev_id`),
...
CREATE TABLE IF NOT EXISTS `route` (
  ...
  `RouteName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `V_C` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `route_recommend` int NOT NULL,
  `route_startdate` date NOT NULL,
  `route_update` date NOT NULL,
  `route_creator` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`RouteID`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `route_sightseeing` (`RouteID`, `Att_ID`, `SortOrder`, `startTime`, `comment`) VALUES
(1, 30, 1, '10:00:00', '記得提早買票'),
(1, 39, 2, '12:00:00', '提前訂位'),
(1, 32, 3, '14:00:00', '拍照好去處'),
(1, 33, 4, '16:00:00', '很適合放電，時間要多保留'),
(1, 31, 5, '18:00:00', ''),
(1, 38, 6, '20:00:00', '好好放鬆，結束一天行程'),
(2, 32, 1, '09:00:00', NULL),
(2, 29, 2, '11:00:00', NULL),
(2, 35, 3, '13:00:00', NULL),
(2, 28, 4, '16:00:00', NULL),
(2, 37, 5, '17:00:00', NULL),
(2, 34, 6, '18:00:00', NULL),
(3, 32, 1, NULL, NULL),
(3, 30, 2, NULL, NULL),
(3, 36, 3, NULL, NULL),
(3, 31, 4, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `route_tag` (
  `RouteID` int NOT NULL,
  `R_Tag` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
