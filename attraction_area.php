                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-3 py-4 px-2">
                                        <select class="form-select" name='att_type'>
                                            <option selected value="0">選擇類型</option>
                                            <option value="食">食</option>
                                            <option value="遊">遊</option><br>
                                        </select>
                                    </div>
            ...
            if (isset($_SESSION['searchdata'])) {
                ...
                if (!empty($attractionsData)) {
                    ...
                    foreach ($attractionsData as $attraction) {
                        $t+=1;
                        echo "{id:" .$t.",name:'". $attraction["att_name"]."',city:'" .$attraction["att_City"]."'},";
                    }
                } else {
                    echo "沒有資料。";
                }
                ...
                productElement.innerHTML = `
                    <div class="product">
                        ...
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                            ...
                            <small class="text-primary">${idData[product.name]}</small><br>
                            <!-- 顯示點閱數 -->
