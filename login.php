        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">登入</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 80vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <form action="php/login_res.php" method="post">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>newTRAVEL</h3>
                            </a>
                            <h3>登入
                            </h3>
                        </div>
                        ...
                        <p class="text-center mb-0">還沒有帳號嗎? <a href="register.html">註冊</a></p>
                    </div>
                </form>
            </div>
        </div>
